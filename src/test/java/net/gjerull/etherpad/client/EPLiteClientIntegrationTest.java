...
public class EPLiteClientIntegrationTest {
    ...
    public void validate_token() throws Exception {
        mockServer.when(HttpRequest.request().withMethod("GET")
                .withPath("/api/1.2.13/checkToken").withBody(
    ...
    public void create_and_delete_group() throws Exception {
        mockServer
                ...
                .respond(HttpResponse.response().withStatusCode(200).withBody(
                        "{\"code\":0,\"message\":\"ok\",\"data\":{\"groupID\":\"g.D83UvymZbQ6VNGGa\"}}"));
    ...
    /**
     * Creates the group if not exists for and list all groups.
     *
     * @throws Exception the exception
     */
    @Test
    public void create_group_if_not_exists_for_and_list_all_groups()
        ...
        mockServer.when(HttpRequest.request().withMethod("GET")
                .withPath("/api/1.2.13/listAllGroups").withBody(
                        "{\"apikey\":\"a04f17343b51afaa036a7428171dd873469cd85911ab43be0503d29d2acbbd58\"}"))
                .respond(HttpResponse.response().withStatusCode(200).withBody(
    ...
    /**
     * Creates the group pads and list them.
     *
     * @throws Exception the exception
     */
    @Test
    public void create_group_pads_and_list_them() throws Exception {
        mockServer
                .when(HttpRequest.request().withMethod("POST")
                        .withPath("/api/1.2.13/createGroup"))
                .respond(HttpResponse.response().withStatusCode(200).withBody(
                        "{\"code\":0,\"message\":\"ok\",\"data\":{\"groupID\":\"g.5pz1d2MJbQWg36WR\"}}"));
        ...
        mockServer
                ...
                .respond(HttpResponse.response().withStatusCode(200).withBody(
                        "{\"code\":0,\"message\":\"ok\",\"data\":{\"data\":null}}"));

        mockServer.when(HttpRequest.request().withMethod("GET")
                .withPath("/api/1.2.13/getPublicStatus").withBody(
        ...
        mockServer.when(HttpRequest.request().withMethod("GET")
                .withPath("/api/1.2.13/isPasswordProtected").withBody(
                        "{\"apikey\":\"a04f17343b51afaa036a7428171dd873469cd85911ab43be0503d29d2acbbd58\",\"padID\":\"g.5pz1d2MJbQWg36WR$integration-test-1\"}"))
                .respond(HttpResponse.response().withStatusCode(200).withBody(
                        "{\"code\":0,\"message\":\"ok\",\"data\":{\"isPasswordProtected\":true}}"));

        mockServer.when(HttpRequest.request().withMethod("GET")
                .withPath("/api/1.2.13/getText").withBody(
                        "{\"apikey\":\"a04f17343b51afaa036a7428171dd873469cd85911ab43be0503d29d2acbbd58\",\"padID\":\"g.5pz1d2MJbQWg36WR$integration-test-2\"}"))
                .respond(HttpResponse.response().withStatusCode(200).withBody(
                        "{\"code\":0,\"message\":\"ok\",\"data\":{\"text\":\"Initial text\\n\"}}"));

        mockServer.when(HttpRequest.request().withMethod("GET")
                .withPath("/api/1.2.13/listPads").withBody(
    ...
    public void create_author() throws Exception {
        ...
        mockServer.when(HttpRequest.request().withMethod("GET")
                .withPath("/api/1.2.13/createAuthor").withBody(
                        "{\"apikey\":\"a04f17343b51afaa036a7428171dd873469cd85911ab43be0503d29d2acbbd58\"}"))
                .respond(HttpResponse.response().withStatusCode(200).withBody(
                        "{\"code\":0,\"message\":\"ok\",\"data\":{\"authorID\":\"a.CqYVIJWl6jyjXCkG\"}}"));

        mockServer
                .when(HttpRequest.request().withMethod("POST")
                        .withPath("/api/1.2.13/createAuthor"))
                .respond(HttpResponse.response().withStatusCode(200).withBody(
                        "{\"code\":0,\"message\":\"ok\",\"data\":{\"authorID\":\"a.CCAQakDI8zW9ulmC\"}}"));

        mockServer.when(HttpRequest.request().withMethod("GET")
                .withPath("/api/1.2.13/getAuthorName").withBody(
    ...
    /**
     * Creates the author with author mapper.
     *
     * @throws Exception the exception
     */
    @Test
    public void create_author_with_author_mapper() throws Exception {
        ...
        mockServer
                ...
                .respond(HttpResponse.response().withStatusCode(200).withBody(
                        "{\"code\":0,\"message\":\"ok\",\"data\":{\"authorID\":\"a.8xo7gjrzRDtBgLD0\"}}"));
    ...
    /**
     * Creates the and delete session.
     *
     * @throws Exception the exception
     */
    @Test
    public void create_and_delete_session() throws Exception {
        ...
        mockServer
                .when(HttpRequest.request().withMethod("POST")
                        .withPath("/api/1.2.13/createGroupIfNotExistsFor"))
                .respond(HttpResponse.response().withStatusCode(200).withBody(
                        "{\"code\":0,\"message\":\"ok\",\"data\":{\"groupID\":\"g.MwPHQh6ZMOnWfoFW\"}}"));
        ...
        mockServer
                ...
                .respond(HttpResponse.response().withStatusCode(200).withBody(
                        "{\"code\":0,\"message\":\"ok\",\"data\":{\"sessionID\":\"s.4bd2fab6a5083b092f8515cd49d2db85\"}}"));
        ...
        mockServer
                .when(HttpRequest.request().withMethod("POST")
                        .withPath("/api/1.2.13/createSession"))
                .respond(HttpResponse.response().withStatusCode(200).withBody(
                        "{\"code\":0,\"message\":\"ok\",\"data\":{\"sessionID\":\"s.5166d0f99fb451fddb6f71eeffdea32f\"}}"));
        ...
        mockServer.when(HttpRequest.request().withMethod("GET")
                .withPath("/api/1.2.13/getSessionInfo").withBody(
                        "{\"apikey\":\"a04f17343b51afaa036a7428171dd873469cd85911ab43be0503d29d2acbbd58\",\"sessionID\":\"s.5166d0f99fb451fddb6f71eeffdea32f\"}"))
                .respond(HttpResponse.response().withStatusCode(200).withBody(
                        "{\"code\":0,\"message\":\"ok\",\"data\":{\"groupID\":\"g.MwPHQh6ZMOnWfoFW\", \"authorID\":\"a.8xo7gjrzRDtBgLD0\", \"validUntil\":"
                                + sessionValidUntil.getTime() / 1000L + "}}"));

        mockServer.when(HttpRequest.request().withMethod("GET")
                .withPath("/api/1.2.13/listSessionsOfGroup").withBody(
                        "{\"apikey\":\"a04f17343b51afaa036a7428171dd873469cd85911ab43be0503d29d2acbbd58\",\"groupID\":\"g.MwPHQh6ZMOnWfoFW\"}"))
                .respond(HttpResponse.response().withStatusCode(200).withBody(
                        "{\"code\":0,\"message\":\"ok\",\"data\":{\"s.4bd2fab6a5083b092f8515cd49d2db85\":{\"groupID\":\"g.MwPHQh6ZMOnWfoFW\", \"authorID\":\"a.8xo7gjrzRDtBgLD0\", \"validUntil\":1574079040}, \"s.5166d0f99fb451fddb6f71eeffdea32f\":{\"groupID\":\"g.MwPHQh6ZMOnWfoFW\", \"authorID\":\"a.8xo7gjrzRDtBgLD0\", \"validUntil\":1574079040}}}"));

        mockServer.when(HttpRequest.request().withMethod("GET")
                .withPath("/api/1.2.13/listSessionsOfAuthor").withBody(
                        "{\"apikey\":\"a04f17343b51afaa036a7428171dd873469cd85911ab43be0503d29d2acbbd58\",\"authorID\":\"a.8xo7gjrzRDtBgLD0\"}"))
                .respond(HttpResponse.response().withStatusCode(200).withBody(
                        "{\"code\":0,\"message\":\"ok\",\"data\":{\"s.4bd2fab6a5083b092f8515cd49d2db85\":{\"groupID\":\"g.MwPHQh6ZMOnWfoFW\", \"authorID\":\"a.8xo7gjrzRDtBgLD0\", \"validUntil\":1574079040}, \"s.5166d0f99fb451fddb6f71eeffdea32f\":{\"groupID\":\"g.MwPHQh6ZMOnWfoFW\", \"authorID\":\"a.8xo7gjrzRDtBgLD0\", \"validUntil\":1574079040}}}"));
    ...
    /**
     * Creates the pad set and get content.
     */
    @Test
    public void create_pad_set_and_get_content() {
        ...
        mockServer.when(HttpRequest.request().withMethod("GET")
                .withPath("/api/1.2.13/getHTML").withBody(
                        "{\"apikey\":\"a04f17343b51afaa036a7428171dd873469cd85911ab43be0503d29d2acbbd58\",\"padID\":\"integration-test-pad\"}"))
                .respond(HttpResponse.response().withStatusCode(200).withBody(
        ...
        try {
            ...
            mockServer.when(HttpRequest.request().withMethod("GET")
                    .withPath("/api/1.2.13/getRevisionsCount").withBody(
                            "{\"apikey\":\"a04f17343b51afaa036a7428171dd873469cd85911ab43be0503d29d2acbbd58\",\"padID\":\"integration-test-pad\"}"))
                    .respond(HttpResponse.response().withStatusCode(200)
                            .withBody(
            ...
            mockServer.when(HttpRequest.request().withMethod("GET")
                    .withPath("/api/1.2.13/getRevisionChangeset").withBody(
                            "{\"apikey\":\"a04f17343b51afaa036a7428171dd873469cd85911ab43be0503d29d2acbbd58\",\"padID\":\"integration-test-pad\"}"))
                    .respond(HttpResponse.response().withStatusCode(200)
                            .withBody(
            ...
            mockServer.when(HttpRequest.request().withMethod("GET")
                    .withPath("/api/1.2.13/createDiffHTML").withBody(
            ...
            mockServer.when(HttpRequest.request().withMethod("GET")
                    .withPath("/api/1.2.13/getAttributePool").withBody(
                            "{\"apikey\":\"a04f17343b51afaa036a7428171dd873469cd85911ab43be0503d29d2acbbd58\",\"padID\":\"integration-test-pad\"}"))
                    .respond(HttpResponse.response().withStatusCode(200)
                            .withBody(
            ...
            mockServer.when(HttpRequest.request().withMethod("GET")
                    .withPath("/api/1.2.13/getSavedRevisionsCount").withBody(
                            "{\"apikey\":\"a04f17343b51afaa036a7428171dd873469cd85911ab43be0503d29d2acbbd58\",\"padID\":\"integration-test-pad\"}"))
                    .respond(HttpResponse.response().withStatusCode(200)
                            .withBody(
            ...
            mockServer.when(HttpRequest.request().withMethod("GET")
                    .withPath("/api/1.2.13/listSavedRevisions").withBody(
                            "{\"apikey\":\"a04f17343b51afaa036a7428171dd873469cd85911ab43be0503d29d2acbbd58\",\"padID\":\"integration-test-pad\"}"))
                    .respond(HttpResponse.response().withStatusCode(200)
                            .withBody(
            ...
            mockServer.when(HttpRequest.request().withMethod("GET")
                    .withPath("/api/1.2.13/padUsersCount").withBody(
                            "{\"apikey\":\"a04f17343b51afaa036a7428171dd873469cd85911ab43be0503d29d2acbbd58\",\"padID\":\"integration-test-pad\"}"))
                    .respond(HttpResponse.response().withStatusCode(200)
                            .withBody(
            ...
            mockServer.when(HttpRequest.request().withMethod("GET")
                    .withPath("/api/1.2.13/padUsers").withBody(
                            "{\"apikey\":\"a04f17343b51afaa036a7428171dd873469cd85911ab43be0503d29d2acbbd58\",\"padID\":\"integration-test-pad\"}"))
                    .respond(HttpResponse.response().withStatusCode(200)
                            .withBody(
            ...
            mockServer.when(HttpRequest.request().withMethod("GET")
                    .withPath("/api/1.2.13/getReadOnlyID").withBody(
                            "{\"apikey\":\"a04f17343b51afaa036a7428171dd873469cd85911ab43be0503d29d2acbbd58\",\"padID\":\"integration-test-pad\"}"))
                    .respond(HttpResponse.response().withStatusCode(200)
                            .withBody(
                                    "{\"code\":0,\"message\":\"ok\",\"data\":{\"getReadOnlyID\":\"r.c1ee72d12be077f432c8da9ee89fdd14\"}}"));

            mockServer.when(HttpRequest.request().withMethod("GET")
                    .withPath("/api/1.2.13/getPadID").withBody(
                            "{\"apikey\":\"a04f17343b51afaa036a7428171dd873469cd85911ab43be0503d29d2acbbd58\",\"roID\":\"r.c1ee72d12be077f432c8da9ee89fdd14\"}"))
                    .respond(HttpResponse.response().withStatusCode(200)
                            .withBody(
            ...
            mockServer.when(HttpRequest.request().withMethod("GET")
                    .withPath("/api/1.2.13/listAuthorsOfPad").withBody(
                            "{\"apikey\":\"a04f17343b51afaa036a7428171dd873469cd85911ab43be0503d29d2acbbd58\",\"padID\":\"integration-test-pad\"}"))
                    .respond(HttpResponse.response().withStatusCode(200)
                            .withBody(
            ...
            mockServer.when(HttpRequest.request().withMethod("GET")
                    .withPath("/api/1.2.13/getLastEdited").withBody(
                            "{\"apikey\":\"a04f17343b51afaa036a7428171dd873469cd85911ab43be0503d29d2acbbd58\",\"padID\":\"integration-test-pad\"}"))
                    .respond(HttpResponse.response().withStatusCode(200)
                            .withBody(
                                    "{\"code\":0,\"message\":\"ok\",\"data\":{\"lastEdited\":1542544893362}}"));
    ...
    /**
     * Creates the pads and list them.
     *
    ...
    public void create_pads_and_list_them() throws InterruptedException {
        ...
        mockServer.when(HttpRequest.request().withMethod("GET")
                .withPath("/api/1.2.13/listAllPads").withBody(
                        "{\"apikey\":\"a04f17343b51afaa036a7428171dd873469cd85911ab43be0503d29d2acbbd58\"}"))
                .respond(HttpResponse.response().withStatusCode(200).withBody(
    ...
    /**
     * Creates the pad and chat about it.
     */
    @Test
    public void create_pad_and_chat_about_it() {
        ...
        mockServer
                .when(HttpRequest.request().withMethod("POST")
                        .withPath("/api/1.2.13/createAuthorIfNotExistsFor"))
                .respond(HttpResponse.response().withStatusCode(200).withBody(
                        "{\"code\":0,\"message\":\"ok\",\"data\":{\"authorID\":\"a.xKSqsPq7eEk9TGrl\"}}"));
        ...
        mockServer
                .when(HttpRequest.request().withMethod("POST")
                        .withPath("/api/1.2.13/createAuthorIfNotExistsFor"))
                .respond(HttpResponse.response().withStatusCode(200).withBody(
                        "{\"code\":0,\"message\":\"ok\",\"data\":{\"authorID\":\"a.QTvJFHjvqOfMvFzw\"}}"));
        ...
        mockServer.when(HttpRequest.request().withMethod("GET")
                .withPath("/api/1.2.13/getChatHead").withBody(
        ...
        mockServer.when(HttpRequest.request().withMethod("GET")
                .withPath("/api/1.2.13/getChatHistory").withBody(
                        "{\"apikey\":\"a04f17343b51afaa036a7428171dd873469cd85911ab43be0503d29d2acbbd58\", \"padID\":\"integration-test-pad-1\"}"))
                .respond(HttpResponse.response().withStatusCode(200).withBody(
